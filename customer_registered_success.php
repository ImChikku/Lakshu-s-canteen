<html>
  ...
  <body>
   ...
   <nav class="navbar navbar-inverse navbar"role="navigation"style="background:;border:10px double white;border-radius:20px;">
...
$query = "INSERT into CUSTOMER(fullname,rollno,email,contact,address,password) VALUES('" . $fullname . "','" . $rollno . "','" . $email . "','" . $contact . "','" . $address ."','" . $password ."')";
