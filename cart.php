...
{
  ?>
  <div class="container" style="width:100%;background-color:red;border:10px double yellow;border-radius:20px;padding:20px;margin-top:0px;color:black">
      <div class="jumbotron">
    ...
    <div class="table-responsive" style="padding-left: 100px; padding-right: 100px;background-color:skyblue;border:10px double white;border-radius:20px;padding:20px;margin-top:50px;" >
<table class="table table-striped" style="background-color:yellow;" >
  <thead class="thead-dark"style="background-color:royalblue;">
<tr>
...
<td><a href="cart.php?action=delete&id=<?php echo $values["food_id"]; ?>">Remove</a></td>
</tr>
