...
$gtotal = 0;
  ...
  foreach($_SESSION["cart"] as $keys => $values)
  {
    ...
    $gtotal = $gtotal + $total;
     ...
     $query = "INSERT INTO ORDERS (F_ID, foodname, price,  quantity, order_date, username, payment, R_ID) 
              VALUES ('" . $F_ID . "','" . $foodname . "','" . $price . "','" . $quantity . "','" . $order_date . "','" . $username . "','" . $payment . "','" . $R_ID . "')";
...
<br>
<a href="COD.php"><input type="submit" name="submit" value="Submit"></a>
